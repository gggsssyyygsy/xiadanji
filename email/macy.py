...
def get_trackings(emails):
    ...
    for email in emails:
        ...
        if not subject:
            continue
        if 'Part of your order ' in subject and 'has shipped' in subject:
            order_number = subject.split('Part of your order ')[1][:10]
...
if __name__ == '__main__':
    ...
    emails = g_account.inbox(start=0, amount=5, date='06/10/2017')
